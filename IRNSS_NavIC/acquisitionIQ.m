function acqResults = acquisitionIQ(longSignal, settings)
...
% Number of the frequency bins for the given acquisition band (250Hz steps)
numberOfFrqBins = round(settings.acqSearchBand * 4) + 1;

% Generate all C/A codes and sample them according to the sampling freq.
%caCodesTable = makeCaTable(settings);
%NavIC
caCodesTable = makeCaTable_NavIC(settings);
...
%% Fine resolution frequency search =======================================
        ...
        %NavIC
        caCode = (double(gnssCACode(PRN,"NavIC L5-SPS")-0.5))';
        caCode = [caCode caCode(1)];
        %
